    ...
    public partial class Form1 : Form
    {
            ...
            if (btnConnect.Text.Equals("Connect"))
            {
                ...
                try
                {
                    ...
                    if (chbLog.Checked)
                    {
                        ...
                        file.WriteLine("temp_degC\taccX_g\taccY_g\taccZ_g\tgyrX_degps\tgyrY_degps\tgyrZ_degps");
                    }
                }
                catch (Exception ex)
                {
        ...
        private void dataReceivedHandler(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                if (chbLog.Checked) file.WriteLine("{0, 0:E5}\t{1, 1:E5}\t{2, 2:E5}\t{3, 3:E5}\t{4, 4:E5}\t{5, 5:E5}\t{6, 6:E5}", temperature, buf[0, bufEnd], buf[1, bufEnd], buf[2, bufEnd], buf[3, bufEnd], buf[4, bufEnd], buf[5, bufEnd]);
