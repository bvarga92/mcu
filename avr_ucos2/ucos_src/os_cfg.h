...
* By   : Jean J. Labrosse
*
* Modification to avr-gcc v. 3.x port  by Julius Luukko (Julius.Luukko@lut.fi) 2003-06-18
*
*********************************************************************************************************
*/

#define CPU_CLOCK_HZ       16000000
#define OS_TICKS_PER_SEC   100           // Minimum 43, maximum ~100


#ifndef OS_CPU_A	/* skip the rest if we're including from the assembler file (os_cpu_a.asm)     */


#define OS_TASK_DEF_STK_SIZE    128    /* Default stack size                                           */

/* Ha engedelyezve van, meghivodik az OSTaskDelMissing() fuggveny (lasd: os_cpu_c.c, ha
 * single-shot taszk szervezesnel elfelejtettuk meghivni OSTaskDel()-t.
 *
 * Figyelem: NEM része a standard uCOS forraskodnak!
 *
 * Naszaly Gabor
 * naszaly@mit.bme.hu
 */
#define OS_TASK_DEL_MISSING_EN 1

#define OS_SCOPE_MONITOR_EN 0
...
/* OS_TICKS_PER_SEC is defined at the top of this file so that the definition can be used in os_cpu_a.asm */
